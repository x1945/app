...
public class TestKapow2 {
	...
	public static void main(String[] args) throws RQLException, RepositoryClientException, InterruptedException {
        ...
        // Create RqlObjectBuilder to construct the inputText input required to call this robot
        RQLObjectBuilder inputObject1 = request.createInputVariable("TestInput");
        inputObject1.setAttribute("url",(String) "xxx.xxx.xxx");
        inputObject1.setAttribute("tilte",(String) "xxx.title");
        inputObject1.setAttribute("content",(String) "xxx.content");
